...
console.log(21, 'moni');
   ...
   useEffect(() => {
      ...
      fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/allproducts")
      .then((response) => response.json())
      .then((data) => {
      ...
      fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/popularinwomen")
      .then((res) => res.json())
      .then((data) => {
      ...
      if (localStorage.getItem("auth-token")) {
         fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/getcart", {
            method: "POST",
            headers: {
      ...
      if (localStorage.getItem("auth-token")) {
         fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/getwishlist", {
            method: "POST",
            headers: {
               Accept: "application/json",
               "auth-token": `${localStorage.getItem("auth-token")}`,
   ...
   const addToCart = (itemId, size) => {
      ...
      if (localStorage.getItem("auth-token")) {
         fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/addtocart", {
            method: "POST",
            headers: {
               Accept: "application/json",
               "auth-token": `${localStorage.getItem("auth-token")}`,
   ...
   const removeFromCart = (itemId) => {
      ...
      if (localStorage.getItem("auth-token")) {
         fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/removefromcart", {
            method: "POST",
            headers: {
               Accept: "application/json",
               "auth-token": `${localStorage.getItem("auth-token")}`,
   ...
   const addToWishlist = (itemId) => {
      setWishlist((prevWishlist) => {
         ...
         if (prevWishlist.includes(itemId)) {
            ...
            fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/removefromwishlist", {
               method: "POST",
               headers: {
                  Accept: "application/json",
                  "auth-token": `${localStorage.getItem("auth-token")}`,
            ...
            fetch("https://e-commerce-website-using-mern-w5l9.onrender.com/addtowishlist", {
               method: "POST",
               headers: {
                  Accept: "application/json",
                  "auth-token": `${localStorage.getItem("auth-token")}`,
